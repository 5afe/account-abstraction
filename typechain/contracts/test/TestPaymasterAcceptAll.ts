...
export interface TestPaymasterAcceptAllInterface extends utils.Interface {
  functions: {
...
export interface TestPaymasterAcceptAll extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPaymasterAcceptAllInterface;
