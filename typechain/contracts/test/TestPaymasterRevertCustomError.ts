...
export interface TestPaymasterRevertCustomErrorInterface
  ...
  functions: {
    ...
    "setRevertType(uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setRevertType",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface TestPaymasterRevertCustomError extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPaymasterRevertCustomErrorInterface;
  ...
  functions: {
    ...
    setRevertType(
      _revertType: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
