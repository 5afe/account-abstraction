...
export interface TestPaymasterWithPostOpInterface extends utils.Interface {
  functions: {
...
export interface TestPaymasterWithPostOp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPaymasterWithPostOpInterface;
